            ...
            <div className="tiles-item reveal-from-bottom" data-reveal-delay="200">
              <div className="tiles-item-inner">
                ...
                <div className="features-tiles-item-content">
                  ...
                  <p className="m-0 text-sm">
                  Gamla.fund <b>smart contract</b> is <b>the fund manager, eliminating</b> the middleman, and ensuring stressfree savings. Minimal fund management costs.
                    </p>
                </div>
              </div>
            </div>
            ...
            <div className="tiles-item reveal-from-bottom" data-reveal-delay="400">
              <div className="tiles-item-inner">
                ...
                <div className="features-tiles-item-content">
                  ...
                  <p className="m-0 text-sm">
                    Gamla.fund exports the <b>trust</b>, its <b>execution</b> to smart-contract, deployed onto polygon blockchain.
                    </p>
                </div>
              </div>
            </div>
